...
import com.shiftos.internal.util.PowerMenuConstants;
...
import static com.shiftos.internal.util.PowerMenuConstants.*;
...
public class PowerMenuActions extends SettingsPreferenceFragment {
    ...
    private void getUserConfig() {
        ...
        String savedActions = ShiftSettings.Secure.getStringForUser(mContext.getContentResolver(),
                ShiftSettings.Secure.POWER_MENU_ACTIONS, UserHandle.USER_CURRENT);
    ...
    private void saveUserConfig() {
        ...
        ShiftSettings.Secure.putStringForUser(getContentResolver(),
                ShiftSettings.Secure.POWER_MENU_ACTIONS, s.toString(), UserHandle.USER_CURRENT);
        updatePowerMenuDialog();
    }

    private void updatePowerMenuDialog() {
        Intent u = new Intent();
        u.setAction(shiftos.content.Intent.ACTION_UPDATE_POWER_MENU);
