 ...
 */
package com.shiftos.shiftparts.search;
...
import com.shiftos.shiftparts.search.Searchable.SearchIndexProvider;
import com.shiftos.internal.shiftparts.PartInfo;
import com.shiftos.internal.shiftparts.PartsList;
import com.shiftos.platform.internal.R;
...
import static com.shiftos.internal.shiftparts.PartsList.SHIFTPARTS_ACTIVITY;

/**
 * Provides search metadata to the Settings app
 */
public class ShiftPartsSearchIndexablesProvider extends SearchIndexablesProvider {

    private static final String TAG = ShiftPartsSearchIndexablesProvider.class.getSimpleName();
    ...
    public Cursor queryXmlResources(String[] strings) {
        ...
        for (String key : keys) {
            ...
            ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_PACKAGE] = SHIFTPARTS_ACTIVITY.getPackageName();
            ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_CLASS] = SHIFTPARTS_ACTIVITY.getClassName();
            cursor.addRow(ref);
        }
        return cursor;
        ...
        for (String key : keys) {
            ...
            for (SearchIndexableRaw raw : rawList) {
                ...
                ref[COLUMN_INDEX_RAW_INTENT_TARGET_PACKAGE] = raw.intentTargetPackage != null ?
                        raw.intentTargetPackage : SHIFTPARTS_ACTIVITY.getPackageName();
                ref[COLUMN_INDEX_RAW_INTENT_TARGET_CLASS] = raw.intentTargetClass != null ?
                        raw.intentTargetClass : SHIFTPARTS_ACTIVITY.getClassName();
