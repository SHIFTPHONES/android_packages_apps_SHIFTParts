...
public class ShiftBaseSystemSettingSwitchBar implements SwitchBar.OnSwitchChangeListener,
    ...
    public ShiftBaseSystemSettingSwitchBar(Context context, SwitchBar switchBar, String key,
    ...
    public void resume(Context context) {
        ...
        if (!mListeningToOnSwitchChange) {
            ...
            SettingsHelper.get(mContext).startWatching(
                    this, ShiftSettings.System.getUriFor(mSettingKey));
    ...
    private void setSwitchState() {
        boolean enabled = ShiftSettings.System.getInt(mContext.getContentResolver(),
    ...
    public void onSwitchChanged(Switch switchView, boolean isChecked) {
        ...
        ShiftSettings.System.putInt(mContext.getContentResolver(),
